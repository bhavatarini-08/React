...
const Navbar = () => {
    ...
    return (
        <> <div className='w-full h-[4rem] flex justify-center items-center bg-pink-600'>
                 <div className='w-[80%] h-full flex justify-center items-center flex-row'>
                    ...
                    <>
                        <div className="h-screen w-screen absolute top-0 left-0 bg-black/20 flex justify-center items-center z-50 rounded-lg">
                            <div className=" h-[60%] w-[30%] bg-red z-50 flex flex-col  bg-white ">
                                <div className="w-full h-[15%] flex flex-row justify-start px-10 items-center border-2 text-pink-600 bg-white text-xl font-bold shadow-sm">
                                    <div className="w-1/2">
                                        LOGIN
                                    </div>
                                    <div className="w-1/2 flex justify-end">
                                        ...
                                        <label className="relative inline-flex items-center cursor-pointer" onClick={() => setvisible(!visible)} >
                                            ...
                                            <div className="peer ring-0 bg-pink-400  rounded-full outline-none duration-300 after:duration-500 w-8 h-8  shadow-md peer-checked:bg-emerald-500  peer-focus:outline-none  after:rounded-full after:absolute after:outline-none after:h-6 after:w-6 after:bg-white after:top-1 after:left-1 after:flex after:justify-center after:items-center  peer-hover:after:scale-75 peer-checked:after:content-['✔️'] after:-rotate-180 peer-checked:after:rotate-0">
                                            </div>
                                        </label>
                                    </div>
                                </div>
                                <div className="w-full h-[85%] flex flex-row justify-center items-center rounded-md">
                                    <form className="w-[80%] h-[80%] flex flex-col justify-center items-center gap-4" onSubmit={handleLogin}>
                                        ...
                                        <button type="submit" className="text-white bg-pink-600 focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800 shadow-lg shadow-purple-500/50 dark:shadow-lg dark:shadow-purple-800/80 font-medium rounded-sm text-md px-5 py-2.5 text-center w-full h-[20%] mt-4">   Login</button>
                                    </form>
                                </div>
